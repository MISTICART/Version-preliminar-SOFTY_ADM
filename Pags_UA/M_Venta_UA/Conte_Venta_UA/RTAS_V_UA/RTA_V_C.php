...
<body>
    ...
    echo "<p>No se encontró la venta con el ID: $id_venta</p>";
         ...
         echo '<table class="table2";>
            <tr>
                <th><a href="../M_Venta_UA.html">MODIFICAR</a></th>
                <th><a href="../C_Venta_UA.html">CONTINUAR</a></th> 
                <th><a href="../E_Venta_UA.html">ELIMINAR</a></th>
            </tr>';
    echo '<form action="descarga_V.php" method="post">
